...
export const Modal = () => {
    ...
    const [topic, setTopic] = useState({ title: '', description: '', categoryIds: [] });
                    ...
                    {categories ? (
                        <div className={styles.categories}>
                            {categories.map((category) => (
                                <span key={category._id}  onClick={() => handleCategoryChange(category._id)}
                                      className={isCategoryActive(category._id) ? styles.activeCategory : ''}
                                >
                                    {category.name}
                                </span>
                            ))}
